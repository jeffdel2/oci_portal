...
function handleLoginAPICall(baseUrl, signIn) {
  console.log("handleLoginAPICall()");
  document.getElementById("apiResultsDisplay").innerHTML = "";
  getJson(baseUrl + '/api/login', signIn, function(json){
    document.getElementById("apiResultsDisplay").innerHTML = JSON.stringify(JSON.parse(json), null, 4);
  });
...
function showChallenge2() {
  ...
  document.getElementById("challenge2Section").style = "width: 50%; float:left;";
  document.getElementById("challenge1Section").style = "width: 50%; float:right;";
}
